...
```
<img class="foreground" src="src/assets/figures/clarity_light.png">
...
```
<img class="foreground" src="src/assets/figures/clarity_dark.png">
...
```
<img class="foreground" src="src/assets/figures/clarity_light_no_cover.png">
...
```
<img class="foreground" src="src/assets/figures/clarity_dark_no_cover.png">
...
<div class="container blog" id="first-content" style="background: linear-gradient(90deg, hsla(298, 68%, 90%, 1) 0%, hsla(30, 82%, 91%, 1) 100%);">
    <div class="blog-title no-cover">
```
<img class="foreground" src="src/assets/figures/clarity_gradient_no_cover.png">
...
<p align="center">
  <img src="src/assets/figures/toc_web.gif"/>
  <img src="src/assets/figures/toc_phone.gif"/>
</p>
...
<p align="center">
  <img src="src/assets/figures/slide_show.gif"/>
</p>
...
<p align="center">
  <img src="src/assets/figures/comparison.gif"/>
</p>
